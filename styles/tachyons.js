module.exports = {
  ...
  "button_reset::_moz_focus_inner": {
    "border": "0",
    "padding": "0"
  },
  "input_reset::_moz_focus_inner": {
    "border": "0",
    "padding": "0"
  },
  "h1": {
  ...
  "striped__light_silver:nth_child(odd)": {
    "backgroundColor": "#aaa"
  },
  "striped__moon_gray:nth_child(odd)": {
    "backgroundColor": "#ccc"
  },
  "striped__light_gray:nth_child(odd)": {
    "backgroundColor": "#eee"
  },
  "striped__near_white:nth_child(odd)": {
    "backgroundColor": "#f4f4f4"
  },
  "stripe_light:nth_child(odd)": {
    "backgroundColor": "rgba( 255, 255, 255, .1 )"
  },
  "stripe_dark:nth_child(odd)": {
    "backgroundColor": "rgba( 0, 0, 0, .1 )"
  },
  "strike": {
